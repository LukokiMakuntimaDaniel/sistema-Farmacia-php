...
<body class="bg-light">
    ...
    <main class="container">
        ...
        <h1>Fármacos em Esgotamento</h1>
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link " aria-current="page" href="relatorio.php">Relatório de Vendas</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " href="maisVendido.php">Fármaco mais Vendido</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="esgotado.php">Fármaco em Esgotamento</a>
            </li>
        </ul>
        ...
        <table id="myTable">
            ...
            <?php  include_once("../php/todosFarmacoEsgotados.php")  ?>
        </table>
        <div class="addopc">
            <div class="adddiv">
